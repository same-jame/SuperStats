!function(){
	...
	var message = '<span>Super Stats has an optional module to allow extended presence status messages, like in PA Chat (e.g. "Viewing Games Browser"). Click the button here to enable it. This message will not be shown again but presence settings can be changed in SETTINGS => Gameplay => Super Stats</span>';
